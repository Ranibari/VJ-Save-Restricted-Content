...
async def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🌐 Update Channel", url="https://t.me/mylifesave_bot")]]), 
...
Here's the full code with the necessary fixes to make it work as expected:
